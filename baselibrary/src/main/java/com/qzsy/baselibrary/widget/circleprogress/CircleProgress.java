package com.qzsy.baselibrary.widget.circleprogress;
...
//        mHintOffset = mCenterPoint.y - mRadius * mTextOffsetPercentInRadius + getBaselineOffsetFromY(mHintPaint);
        mValueOffset = mCenterPoint.y - mRadius * mTextOffsetPercentInRadius + getBaselineOffsetFromY(mValuePaint);

        mHintOffset = mCenterPoint.y + getBaselineOffsetFromY(mHintPaint);
//        mUnitOffset = mCenterPoint.y + mRadius * mTextOffsetPercentInRadius + getBaselineOffsetFromY(mUnitPaint);
    ...
    private void drawText(Canvas canvas) {
        ...
        String value = String.format(mPrecisionFormat, mValue)+"%";
        canvas.drawText(value, mCenterPoint.x, mValueOffset, mValuePaint);

        if (mHint != null) {
            canvas.drawText(mHint.toString(), mCenterPoint.x, mHintOffset+30, mHintPaint);
        }
...
//        }
    ...
    private void drawArc(Canvas canvas) {
        ...
        if (mValue==0){
            canvas.drawArc(mRectF, 2, currentAngle+2, false, mArcPaint);
        }else {
