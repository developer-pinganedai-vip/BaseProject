...
public class OperatorUtil {
    ...
    private static String UNICOM = "CUCC";
    private static String TELECOM = "CTCC";
    ...
    public static String execute(String phone) {
        ...
        boolean cmcctemp3 = head1.equals("134") || head1.equals("135") || head1.equals("136")
                ...
                || head1.equals("172") || head1.equals("178")
        ...
        boolean cmcctemp4 = head2.equals("1340") || head2.equals("1341")
                ...
                || head2.equals("1703") || head2.equals("1706");
        if (cmcctemp4) {
            return CMCC;
        }
        // 联通前3位
        boolean unicomtemp = head1.equals("130") || head1.equals("131")
                ...
                || head1.equals("166") || head1.equals("171")
                || head1.equals("175") || head1.equals("176")
                || head1.equals("185") || head1.equals("186");
        if (unicomtemp) {
            return UNICOM;
        }
        //unicom 4
        boolean unicomtemp4 = head1.equals("1704") || head1.equals("1709")
                || head1.equals("1707") || head1.equals("1708");
        if (unicomtemp4) {
            return UNICOM;
        }
        // 电信前3位
        ...
        //telecom 4
        boolean telecomtemp4 = head1.equals("1700") || head1.equals("1701") || head1.equals("1702");
        if (telecomtemp4) {
            return TELECOM;
        }
        return UNKNOWN;
