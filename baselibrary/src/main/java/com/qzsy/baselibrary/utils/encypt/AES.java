package com.qzsy.baselibrary.utils.encypt;
...
public class AES {
    ...
    public static String encrypt(String sSrc){
        ...
        try {
            ...
            encryptStr = new String(Base64.encode(encrypted,Base64.NO_WRAP),"utf-8");
        }catch (Exception e){
            encryptStr = "";
        }
        return encryptStr;
    ...
    public static String decrypt(String sSrc){
        ...
        try {
            ...
            byte[] encrypted = Base64.decode(sSrc.getBytes("utf-8"),Base64.NO_WRAP);// 先用base64解码
            byte[] original = cipher.doFinal(encrypted);
            decryptStr = new String(original, "utf-8");
        }catch (Exception e){
            decryptStr = "";
        }
        return decryptStr;
